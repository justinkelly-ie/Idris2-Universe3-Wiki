...
`Idris2-Universe-Wiki` serves as the primary literate textbook and master verification test suite for the **Constructive Multiset Physics Framework**:
...
- **Master Executable**: `universe-verify` running all 171 test witnesses and compile-time macro invariants in under 0.002 seconds.
